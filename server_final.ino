...
// final code that we ran for ee327 (previously named "this fucker")
  ...
  if ((millis() - lastDebounceTime) > debounceDelay) {
    ...
    if (reading != buttonState) {
      ...
      if (buttonState == HIGH) {
        ...
        Serial.println("starting to take an image now");
        //take an image
        camera_fb_t * fb = NULL;
        ...
        if(!fb) {
          ...
          if(WiFi.status()== WL_CONNECTED){
            ...
            if (httpResponseCode>0) {
              ...
              Serial.println("sweet it worked");
              }
            else {
